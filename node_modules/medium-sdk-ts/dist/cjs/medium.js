...
exports.PostContentFormat = exports.PostLicense = exports.PostPublishStatus = exports.MediumError = exports.MediumClient = void 0;
const types_1 = require("./types");
Object.defineProperty(exports, "PostContentFormat", { enumerable: true, get: function () { return types_1.PostContentFormat; } });
Object.defineProperty(exports, "PostLicense", { enumerable: true, get: function () { return types_1.PostLicense; } });
Object.defineProperty(exports, "PostPublishStatus", { enumerable: true, get: function () { return types_1.PostPublishStatus; } });
const DEFAULT_ERROR_CODE = -1;
const DEFAULT_TIMEOUT_MS = 5000;
const { MEDIUM_ACCESS_TOKEN, MEDIUM_POST_STATUS = types_1.PostPublishStatus.DRAFT, MEDIUM_POST_LICENSE = types_1.PostLicense.ALL_RIGHTS_RESERVED, } = process.env;
...
exports.MediumError = MediumError;
class MediumClient {
    _accessToken;
    ...
    async createPost({ title, content, userId, tags, canonicalUrl, license = MEDIUM_POST_LICENSE, publishedAt, publishStatus = MEDIUM_POST_STATUS, contentFormat = types_1.PostContentFormat.MARKDOWN, }) {
        if (!userId)
...
exports.MediumClient = MediumClient;
const graphqlQuery = `
